...
<?php
	...
	if($_POST){
		...
		$query = "SELECT * FROM answer_uni_eng_option WHERE question_number = $number AND is_correct = 1";
		...
		if($number == $total_questions){
			header("LOCATION: final_eng_uni.php");
		}else{
			header("LOCATION: start_eng_uni.php?n=". $next);
		}
