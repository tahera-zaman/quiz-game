...
<html>
	...
	<?php
		...
		if(isset($_POST['submit_admin']))
		{
			...
			$query = "INSERT INTO question_math_eng (";
			...
			if($result)
			{
				...
				foreach($choice as $option => $value)
				{
					if($value != "")
					{
						...
						$query = "INSERT INTO answer_uni_math_option (";
	...
	<?php
		...
		if(isset($_REQUEST['delid']))
		{
			...
			$sql = "DELETE FROM question_uni_math WHERE question_number='$delid'";
			$sql_a = "DELETE FROM answer_uni_math_option WHERE question_number='$delid'";
	...
	<div class="head">
		...
		<div class="loginfo">
			<th>
				<h3><a href="admin_login.php">Logout</a>
			</th>
		</div>
		...
		<div style="background-color: white;  padding: 20px;">
			...
			<form  method="post"  style="background-color: white;  padding: 20px;">
				...
				if(isset($message))
					echo "<h4>" . $message . "</h4>";
				?>
				<h1 style="text-align: center">University Level Mathametics Question</h1></br>
					<b>
						<p>
			...
			<button style="padding: 10px;  width: 10%; margin-left: 15%"><a href="uni_math.php"> Cancel </a> </button>
			...
			<?php
				...
				$sql_q = "SELECT * FROM question_uni_math";
				$sql_a = "SELECT * FROM answer_uni_math_option";
