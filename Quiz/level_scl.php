...
<html>
	...
	<body>
		...
		<div style="background-color: #ccc; padding: 115px;">
			...
			<h1> Knowledge Test for School Students </h1>
				
			<h3> Choose Your Category </h3>
			
			<button style="padding: 20px;"> <a href="user_gk_scl.php"> General Knowledge </a> </button>
			
			<button style="padding: 20px;"> <a href="user_ict_scl.php"> ICT </a> </button>
			
			<button style="padding: 20px;"> <a href="user_eng_scl.php"> English </a> </button>
			
			<button style="padding: 20px;"> <a href="user_math_scl.php"> Math </a> </button>
