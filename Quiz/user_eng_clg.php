...
<html>
	...
	<body>
		...
		<div style="background-color: #ccc; padding: 115px;">
			...
			<button style="padding: 20px;"> <a href="start_eng_clg.php?n=1"> Start Quiz </a> </button>
			
			<button style="padding: 20px;"> <a href="level_clg.php"> Back </a> </button>
			
		</div>
		<div class="foter">
		
			<p> Developed By <font color="Black"> &copy Abid Khan & Tania Sultana </font> </p>
