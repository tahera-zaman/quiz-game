	...
	<body>
		...
		<div style="background-color: #ccc;">
			<div size="4" align="center">
				...
				<form method="post" action="Login.php" style="background-color: #fff; padding: 20px; margin-left: 25%; margin-right: 25%; margin-bottom: 10%;">
					
					<p> <input type="email" name="email_reco" style="padding: 5px; top: 2px; width: 50%;" placeholder="Email"> </p>
				
					<p> <input type="submit" name="recovery" style="padding: 5px; top: 2px; bgcolor: green; min-width: 20px;" value="Recovery"> </p>
