...
<?php
	...
	// Query for Question
	$query = "SELECT * FROM question_school_gk WHERE question_number = $number";
	...
	// Get Option
	$query = "SELECT * FROM answer_scl_gk_option WHERE question_number = $number";
...
<html>
	...
	<body>
		...
		<div style="background-color: #ccc; padding: 115px;">
			...
			<form method="POST" action="process_gk_scl.php">
