...
<html>
	...
	<?php
		...
		if(isset($_REQUEST['delid']))
		{
			...
			$sql = "DELETE FROM question_school_ict WHERE question_number='$delid'";
			$sql_a = "DELETE FROM answer_scl_ict_option WHERE question_number='$delid'";
	...
	<body>
		...
		<div style="background-color: white;  padding: 20px;">
			...
			<button style="padding: 10px;  width: 10%; margin-left: 15%"><a href="scl_ict.php"> Cancel </a> </button>
			...
			<?php
				...
				$sql_q = "SELECT * FROM question_school_ict";
				$sql_a = "SELECT * FROM answer_scl_ict_option";
