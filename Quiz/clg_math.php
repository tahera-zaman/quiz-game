...
<html>
	...
	<?php
		...
		if(isset($_POST['submit_admin']))
		{
			...
			$query = "INSERT INTO question_college_math (";
			...
			if($result)
			{
				...
				foreach($choice as $option => $value)
				{
					if($value != "")
					{
						...
						$query = "INSERT INTO answer_clg_math_option (";
		...
		$query = "SELECT * FROM question_college_math";
	...
	<?php
		...
		if(isset($_REQUEST['delid']))
		{
			...
			$sql = "DELETE FROM question_college_math WHERE question_number='$delid'";
			$sql_a = "DELETE FROM answer_clg_math_option WHERE question_number='$delid'";
		...
		<div style="background-color: white;  padding: 20px;">
			...
			<form  method="post"  style="background-color: white;  padding: 20px;">
				...
				if(isset($message))
					echo "<h4>" . $message . "</h4>";
				?>
				<h1 style="text-align: center">College Level Mathametics Question</h1></br>
					<b>
						<p>
			...
			<button style="padding: 10px;  width: 10%; margin-left: 15%"><a href="clg_math.php"> Cancel </a> </button>
			...
			<?php
				...
				$sql_q = "SELECT * FROM question_college_math";
				$sql_a = "SELECT * FROM answer_clg_math_option";
