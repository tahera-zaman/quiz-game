...
<?php
	...
	// Query for Question
	$query = "SELECT * FROM question_college_gk WHERE question_number = $number";
	...
	// Get Option
	$query = "SELECT * FROM answer_clg_gk_option WHERE question_number = $number";
...
<html>
	...
	<body>
		...
		<div style="background-color: #ccc; padding: 115px;">
			...
			<form method="POST" action="process_gk_clg.php">
