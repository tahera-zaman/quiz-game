...
<html>
	...
	<?php
		...
		if(isset($_POST['submit_admin']))
		{
			...
			$query = "INSERT INTO question_school_eng (";
			...
			if($result)
			{
				...
				foreach($choice as $option => $value)
				{
					if($value != "")
					{
						...
						$query = "INSERT INTO answer_scl_eng_option (";
		...
		$query = "SELECT * FROM question_school_eng";
	...
	<?php
		...
		if(isset($_REQUEST['delid']))
		{
			...
			$sql = "DELETE FROM question_school_eng WHERE question_number='$delid'";
			$sql_a = "DELETE FROM answer_scl_eng_option WHERE question_number='$delid'";
		...
		<div style="background-color: white;  padding: 20px;">
			...
			<form  method="post"  style="background-color: white;  padding: 20px;">
				...
				if(isset($message))
					echo "<h4>" . $message . "</h4>";
				?>
				<h1 style="text-align: center">School Level English Question</h1></br>
					<b>
						<p>
			...
			<button style="padding: 10px;  width: 10%; margin-left: 15%"><a href="scl_eng.php"> Cancel </a> </button>
			...
			<?php
				...
				$sql_q = "SELECT * FROM question_school_eng";
				$sql_a = "SELECT * FROM answer_scl_eng_option";
