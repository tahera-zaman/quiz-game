...
<html>
	...
	<body>
		...
		<div style="background-color: #ccc; padding: 115px;">
			...
			<h1> Knowledge Test for University Students </h1>
				
			<h3> Choose Your Category </h3>
			
			<button style="padding: 20px;"> <a href="user_gk_uni.php"> General Knowledge </a> </button>
			
			<button style="padding: 20px;"> <a href="user_ict_uni.php"> ICT </a> </button>
			
			<button style="padding: 20px;"> <a href="user_eng_uni.php"> English </a> </button>
			
			<button style="padding: 20px;"> <a href="user_math_uni.php"> Math </a> </button>
