...
<?php
	...
	if($_POST){
		...
		$query = "SELECT * FROM answer_uni_ict_option WHERE question_number = $number AND is_correct = 1";
		...
		if($number == $total_questions){
			header("LOCATION: final_ict_uni.php");
		}else{
			header("LOCATION: start_ict_uni.php?n=". $next);
		}
