...
<?php
	...
	// Query for Question
	$query = "SELECT * FROM question_school_math WHERE question_number = $number";
	...
	// Get Option
	$query = "SELECT * FROM answer_scl_math_option WHERE question_number = $number";
...
<html>
	...
	<body>
		...
		<div style="background-color: #ccc; padding: 115px;">
			...
			<form method="POST" action="process_math_scl.php">
